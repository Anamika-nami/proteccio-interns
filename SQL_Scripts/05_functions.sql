...
DECLARE
  ...
  v_role_id UUID;
BEGIN
  -- Smart Org Selection: try proteccio-interns -> default-org -> first available
  SELECT id INTO v_org_id FROM public.organizations WHERE slug = 'proteccio-interns' LIMIT 1;
